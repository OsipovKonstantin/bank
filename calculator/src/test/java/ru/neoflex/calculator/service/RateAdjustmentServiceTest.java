...
import ru.neoflex.calculator.util.TestUtils;
...
class RateAdjustmentServiceTest {
    ...
    static Stream<Arguments> scoreRateTestCases() {
        ...
        return Stream.of(
                ...
                Arguments.of(validScoringDataDto.withEmployment(validEmploymentDto
                                .withPosition(EmploymentPosition.MID_MANAGER)), prescoredRate,
                        prescoredRate.add(SELF_EMPLOYED_PENALTY).subtract(MID_MANAGER_DISCOUNT)
                                .subtract(MARRIED_DISCOUNT).subtract(WORKING_AGE_DISCOUNT)),
                Arguments.of(validScoringDataDto.withEmployment(validEmploymentDto
                        .withPosition(EmploymentPosition.TOP_MANAGER)), prescoredRate, prescoredRate
